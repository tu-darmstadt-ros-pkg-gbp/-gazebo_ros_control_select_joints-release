...
Name:           ros-noetic-gazebo-ros-control-select-joints
Version:        2.5.7
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS gazebo_ros_control_select_joints package

License:        BSD
URL:            http://ros.org/wiki/gazebo_ros_control_select_joints
...
%changelog
* Thu Dec 17 2020 Stefan Fabian <fabian@sim.tu-darmstadt.de> - 2.5.7-1
- Autogenerated by Bloom

* Thu Dec 17 2020 Jose Luis Rivero <jrivero@osrfoundation.org> - 2.5.6-1
- Autogenerated by Bloom
